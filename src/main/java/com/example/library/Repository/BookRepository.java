...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Query("select new com.example.library.Entity.Book(b.id, b.name, b.pageCount, b.uniqueNumber, b.genre, b.author, b.publisher, b.publishYear, b.image, b.decription, b.viewCount, b.totalRating, b.totalVoteCount, b.avgRating) from Book b")
    ...
    // поиск книг по жанру
    @Query("select new com.example.library.Entity.Book(b.id, b.name, b.pageCount, b.uniqueNumber, b.genre, b.author, b.publisher, b.publishYear, b.image, b.decription, b.viewCount, b.totalRating, b.totalVoteCount, b.avgRating) from Book b where b.genre.id=:genreId")
